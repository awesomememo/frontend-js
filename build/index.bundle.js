...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _Constant__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Constant */ \"./src/Constant.js\");\n/* harmony import */ var _ui_IndexUI__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ui/IndexUI */ \"./src/ui/IndexUI.js\");\n/* harmony import */ var _service_UserService__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./service/UserService */ \"./src/service/UserService.js\");\n/* harmony import */ var _lib_Util__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./lib/Util */ \"./src/lib/Util.js\");\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n\n\n\n\nvar userService = new _service_UserService__WEBPACK_IMPORTED_MODULE_2__[\"default\"]();\nvar ui = new _ui_IndexUI__WEBPACK_IMPORTED_MODULE_1__[\"default\"](document);\nwindow.addEventListener(\"DOMContentLoaded\", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {\n  var currUserId, currUser;\n  return regeneratorRuntime.wrap(function _callee$(_context) {\n    while (1) {\n      switch (_context.prev = _context.next) {\n        case 0:\n          currUserId = localStorage.getItem(_Constant__WEBPACK_IMPORTED_MODULE_0__[\"CURR_USER_KEY\"]);\n\n          if (!(currUserId === null)) {\n            _context.next = 4;\n            break;\n          }\n\n          ui.logout();\n          return _context.abrupt(\"return\");\n\n        case 4:\n          _context.next = 6;\n          return userService.getUserById(currUserId);\n\n        case 6:\n          currUser = _context.sent;\n          ui.logIn(currUser.username);\n\n        case 8:\n        case \"end\":\n          return _context.stop();\n      }\n    }\n  }, _callee);\n})));\nui.logoutBtn.addEventListener(\"click\", function () {\n  ui.logout();\n  localStorage.removeItem(_Constant__WEBPACK_IMPORTED_MODULE_0__[\"CURR_USER_KEY\"]);\n});\nuserService.getUserById(localStorage.getItem(_Constant__WEBPACK_IMPORTED_MODULE_0__[\"CURR_USER_KEY\"])).then(function (userObj) {\n  var numStreakInSevenDays = Math.min(userObj.streak, 7);\n  ui.paintStreak(numStreakInSevenDays);\n});\n_lib_Util__WEBPACK_IMPORTED_MODULE_3__[\"default\"].closeNavbarAtClickOutside();\n\n//# sourceURL=webpack:///./src/index.js?");
